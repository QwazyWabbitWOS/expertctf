...
void InitGame (void)
{
	gi.dprintf ("==== InitGame ECTF "EXPERT_VERSION" built "__DATE__" ====\n");
	...
	/*
	sv_fogenabled = gi.cvar("sv_fogenabled", "1",0);
	sv_fogclipping = gi.cvar("sv_fogclipping","100",0);
	sv_fogred = gi.cvar("sv_fogred","0.2",0);
	sv_foggreen = gi.cvar("sv_foggreen", "0.2", 0);
	sv_fogblue = gi.cvar("sv_fogblue", "0.2", 0);
	sv_fogdensity =  gi.cvar("sv_fogdensity",".35",0);
	*/
	// noset vars
...
// only support deathmatch
	...
	filterban = gi.cvar ("filterban", "2", 0);
