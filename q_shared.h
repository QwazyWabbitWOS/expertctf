...
do { \
	...
	#define	MAX_STRING_TOKENS	80		//80		// max tokens resulting from Cmd_TokenizeString
	#define	MAX_TOKEN_CHARS	128	//128		// max length of an individual token
	...
	*/
	...
	#define EF_QUAD				0x00008000		// blue shield
	#define EF_PENT				0x00010000		// red shield
	...
	*/
	...
	// Spider: stolen for timeleft in hud (dm and ctf... still use helpicon for single)
	...
	*/
	...
	//#define CS_GENERAL		(MAX_CONFIGSTRINGS)
