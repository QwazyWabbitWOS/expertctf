...
void loadTeams(void)
{
	...
	gi.dprintf("Expert Quake2 Teamplay\nLoading team definitions...\n");
...
{	
	...
	gi.AddCommandString("sv prop bonita/secure	8\n");
	gi.AddCommandString("sv prop bonita/roger		8\n");
	gi.AddCommandString("sv prop bonita/return	8\n");
	gi.AddCommandString("sv prop bonita/qsecure	8\n");
	gi.AddCommandString("sv prop bonita/overrun	8\n");
	gi.AddCommandString("sv prop bonita/onit		8\n");
	gi.AddCommandString("sv prop bonita/offense	8\n");
	gi.AddCommandString("sv prop bonita/nocando	8\n");
	gi.AddCommandString("sv prop bonita/no			8\n");
	gi.AddCommandString("sv prop bonita/move		3\n");
	gi.AddCommandString("sv prop bonita/incoming	8\n");
	gi.AddCommandString("sv prop bonita/hold		4\n");
	gi.AddCommandString("sv prop bonita/followme	4\n");
	gi.AddCommandString("sv prop bonita/flag		8\n");
	gi.AddCommandString("sv prop bonita/find		8\n");
	gi.AddCommandString("sv prop bonita/excuse	3\n");
	gi.AddCommandString("sv prop bonita/defense	8\n");
	gi.AddCommandString("sv prop bonita/coverme	1\n");
	gi.AddCommandString("sv prop bonita/cap		8\n");
	gi.AddCommandString("sv prop bonita/base		8\n");
	gi.AddCommandString("sv prop bonita/affirm	8\n");

	gi.AddCommandString("sv prop boom/yes			8\n");
	gi.AddCommandString("sv prop boom/secure		8\n");
	gi.AddCommandString("sv prop boom/roger		8\n");
	gi.AddCommandString("sv prop boom/return		8\n");
	gi.AddCommandString("sv prop boom/qsecure		8\n");
	gi.AddCommandString("sv prop boom/overrun		8\n");
	gi.AddCommandString("sv prop boom/onit			8\n");
	gi.AddCommandString("sv prop boom/offense		8\n");
	gi.AddCommandString("sv prop boom/nocando		8\n");
	gi.AddCommandString("sv prop boom/no			8\n");
	gi.AddCommandString("sv prop boom/move			3\n");
	gi.AddCommandString("sv prop boom/incoming	8\n");
	gi.AddCommandString("sv prop boom/hold			4\n");
	gi.AddCommandString("sv prop boom/followme	4\n");
	gi.AddCommandString("sv prop boom/flag			8\n");
	gi.AddCommandString("sv prop boom/find			8\n");
	gi.AddCommandString("sv prop boom/excuse		3\n");
	gi.AddCommandString("sv prop boom/defense		8\n");
	gi.AddCommandString("sv prop boom/coverme		1\n");
	gi.AddCommandString("sv prop boom/cap			8\n");
	gi.AddCommandString("sv prop boom/base			8\n");
	gi.AddCommandString("sv prop boom/affirm		8\n");

	gi.AddCommandString("sv prop cali/yes			8\n");
	gi.AddCommandString("sv prop cali/secure		8\n");
	gi.AddCommandString("sv prop cali/roger		8\n");
	gi.AddCommandString("sv prop cali/return		8\n");
	gi.AddCommandString("sv prop cali/qsecure		8\n");
	gi.AddCommandString("sv prop cali/overrun		8\n");
	gi.AddCommandString("sv prop cali/onit			8\n");
	gi.AddCommandString("sv prop cali/offense		8\n");
	gi.AddCommandString("sv prop cali/nocando		8\n");
	gi.AddCommandString("sv prop cali/no			8\n");
	gi.AddCommandString("sv prop cali/move			3\n");
	gi.AddCommandString("sv prop cali/incoming	8\n");
	gi.AddCommandString("sv prop cali/hold			4\n");
	gi.AddCommandString("sv prop cali/followme	4\n");
	gi.AddCommandString("sv prop cali/flag			8\n");
	gi.AddCommandString("sv prop cali/find			8\n");
	gi.AddCommandString("sv prop cali/excuse		3\n");
	gi.AddCommandString("sv prop cali/defense		8\n");
	gi.AddCommandString("sv prop cali/coverme		1\n");
	gi.AddCommandString("sv prop cali/cap			8\n");
	gi.AddCommandString("sv prop cali/base			8\n");
	gi.AddCommandString("sv prop cali/affirm		8\n");

	gi.AddCommandString("sv prop harl/yes			8\n");
	gi.AddCommandString("sv prop harl/secure		8\n");
	gi.AddCommandString("sv prop harl/roger		8\n");
	gi.AddCommandString("sv prop harl/return		8\n");
	gi.AddCommandString("sv prop harl/qsecure		8\n");
	gi.AddCommandString("sv prop harl/overrun		8\n");
	gi.AddCommandString("sv prop harl/onit			8\n");
	gi.AddCommandString("sv prop harl/offense		8\n");
	gi.AddCommandString("sv prop harl/nocando		8\n");
	gi.AddCommandString("sv prop harl/no			8\n");
	gi.AddCommandString("sv prop harl/move			3\n");
	gi.AddCommandString("sv prop harl/incoming	8\n");
	gi.AddCommandString("sv prop harl/hold			4\n");
	gi.AddCommandString("sv prop harl/followme	4\n");
	gi.AddCommandString("sv prop harl/flag			8\n");
	gi.AddCommandString("sv prop harl/find			8\n");
	gi.AddCommandString("sv prop harl/excuse		3\n");
	gi.AddCommandString("sv prop harl/defense		8\n");
	gi.AddCommandString("sv prop harl/coverme		1\n");
	gi.AddCommandString("sv prop harl/cap			8\n");
	gi.AddCommandString("sv prop harl/base			8\n");
	gi.AddCommandString("sv prop harl/affirm		8\n");
	gi.AddCommandString("sv prop harl/heehyoo		8\n");
	gi.AddCommandString("sv prop harl/bitch		8\n");

	gi.AddCommandString("sv prop octo/yes			8\n");
	gi.AddCommandString("sv prop octo/secure		8\n");
	gi.AddCommandString("sv prop octo/roger		8\n");
	gi.AddCommandString("sv prop octo/return		8\n");
	gi.AddCommandString("sv prop octo/qsecure		8\n");
	gi.AddCommandString("sv prop octo/overrun		8\n");
	gi.AddCommandString("sv prop octo/onit			8\n");
	gi.AddCommandString("sv prop octo/offense		8\n");
	gi.AddCommandString("sv prop octo/nocando		8\n");
	gi.AddCommandString("sv prop octo/no			8\n");
	gi.AddCommandString("sv prop octo/move			3\n");
	gi.AddCommandString("sv prop octo/incoming	8\n");
	gi.AddCommandString("sv prop octo/hold			4\n");
	gi.AddCommandString("sv prop octo/followme	4\n");
	gi.AddCommandString("sv prop octo/flag			8\n");
	gi.AddCommandString("sv prop octo/find			8\n");
	gi.AddCommandString("sv prop octo/excuse		3\n");
	gi.AddCommandString("sv prop octo/defense		8\n");
	gi.AddCommandString("sv prop octo/coverme		1\n");
	gi.AddCommandString("sv prop octo/cap			8\n");
	gi.AddCommandString("sv prop octo/base			8\n");
	gi.AddCommandString("sv prop octo/affirm		8\n");

	gi.AddCommandString("sv prop styles/yes		8\n");
	gi.AddCommandString("sv prop styles/secure	8\n");
	gi.AddCommandString("sv prop styles/roger		8\n");
	gi.AddCommandString("sv prop styles/return	8\n");
	gi.AddCommandString("sv prop styles/qsecure	8\n");
	gi.AddCommandString("sv prop styles/overrun	8\n");
	gi.AddCommandString("sv prop styles/onit		8\n");
	gi.AddCommandString("sv prop styles/offense	8\n");
	gi.AddCommandString("sv prop styles/nocando	8\n");
	gi.AddCommandString("sv prop styles/no			8\n");
	gi.AddCommandString("sv prop styles/move		3\n");
	gi.AddCommandString("sv prop styles/incoming	8\n");
	gi.AddCommandString("sv prop styles/hold		4\n");
	gi.AddCommandString("sv prop styles/followme	4\n");
	gi.AddCommandString("sv prop styles/follow	8\n");
	gi.AddCommandString("sv prop styles/flag		8\n");
	gi.AddCommandString("sv prop styles/find		8\n");
	gi.AddCommandString("sv prop styles/excuse	3\n");
	gi.AddCommandString("sv prop styles/defense	8\n");
	gi.AddCommandString("sv prop styles/coverme	1\n");
	gi.AddCommandString("sv prop styles/cap		8\n");
	gi.AddCommandString("sv prop styles/base		8\n");
	gi.AddCommandString("sv prop styles/affirm	8\n");

	gi.AddCommandString("sv prop zapper/yes		8\n");
	gi.AddCommandString("sv prop zapper/secure	8\n");
	gi.AddCommandString("sv prop zapper/roger		8\n");
	gi.AddCommandString("sv prop zapper/return	8\n");
	gi.AddCommandString("sv prop zapper/qsecure	8\n");
	gi.AddCommandString("sv prop zapper/overrun	8\n");
	gi.AddCommandString("sv prop zapper/onit		8\n");
	gi.AddCommandString("sv prop zapper/offense	8\n");
	gi.AddCommandString("sv prop zapper/nocando	8\n");
	gi.AddCommandString("sv prop zapper/no			8\n");
	gi.AddCommandString("sv prop zapper/move		3\n");
	gi.AddCommandString("sv prop zapper/incoming	8\n");
	gi.AddCommandString("sv prop zapper/hold		4\n");
	gi.AddCommandString("sv prop zapper/followme	4\n");
	gi.AddCommandString("sv prop zapper/flag		8\n");
	gi.AddCommandString("sv prop zapper/find		8\n");
	gi.AddCommandString("sv prop zapper/excuse	3\n");
	gi.AddCommandString("sv prop zapper/defense	8\n");
	gi.AddCommandString("sv prop zapper/coverme	1\n");
	gi.AddCommandString("sv prop zapper/cap		8\n");
	gi.AddCommandString("sv prop zapper/base		8\n");
	gi.AddCommandString("sv prop zapper/affirm	8\n");
}
